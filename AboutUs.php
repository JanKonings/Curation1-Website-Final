...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CSS/aboutUs.css?v=9">
    ...
    <script src="Javascript/aboutUs.js?v=4"></script>
</head>
<body>
    <div class="header">
    ...
    <div class="letterContainer">
        ...
        <img src="Images/Untitled_Artwork-1.png?v=3" id="letterImg">
    </div>
